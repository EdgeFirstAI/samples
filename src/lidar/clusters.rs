...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let rec = rerun::RecordingStreamBuilder::new("lidar/clusters Example")
        .save(args.rerun.unwrap_or("lidar-clusters.rrd".into()))?;
    ...
    while let Ok(msg) = subscriber.recv() {
        ...
        let _ = rec.log("lidar/clusters", &rr_points);
    }
