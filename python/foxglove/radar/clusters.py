...
from foxglove.schemas import PackedElementField, PackedElementFieldNumericType, PointCloud, Pose, Vector3, Quaternion
import foxglove
import threading
import struct
...
def clusters_worker(msg):
    ...
    foxglove.log("radar/clusters", pc)
...
def main():
    parser = ArgumentParser(description="EdgeFirst Samples - Radar Clusters")
