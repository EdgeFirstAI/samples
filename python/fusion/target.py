...
if __name__ == "__main__":
    args = ArgumentParser(description="EdgeFirst Samples - Fusion Targets")
    args.add_argument('-r', '--remote', type=str, default=None,
                      help="Connect to the remote endpoint instead of local.")
    rr.script_add_args(args)
    args = args.parse_args()

    rr.script_setup(args, "fusion-targets")
    ...
    subscriber = session.declare_subscriber('rt/fusion/targets')
    ...
    while True:
        ...
        rr.log("fusion/targets", rr.Points3D(pos, colors=colors))
