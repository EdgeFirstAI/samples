...
if __name__ == "__main__":
    ...
    rr.init("radar/clusters")
    rr.save("radar-clusters.rrd")
    ...
    while True:
        ...
        max_id = max(max([p.id for p in clustered_points]), 1)
        pos = [[p.x, p.y, p.z] for p in clustered_points]
        colors = [color_map(turbo_colormap_data, p.id/max_id) for p in clustered_points]
